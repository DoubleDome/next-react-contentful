...
import './ImageSlider.scss'; // build-ignore-line
...
class ImageSlider extends React.PureComponent {
  ...
  stopBarAnimation() {
    ...
    Array.prototype.forEach.call(fillEls, fillEl => {
      ...
      fillEl.style.transition = `max-width 50000s ease-out, opacity ${animationSpeed}ms ease-in-out`;
    });
  }
            ...
            {images.map((image, index) => (
              ...
              >
                <button
                  ...
                  onKeyPress={e =>
                    e.key === 'Enter' && this.handleBarButtonClick(index)
                  }
