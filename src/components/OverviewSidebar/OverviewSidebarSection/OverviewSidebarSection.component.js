...
import './OverviewSidebarSection.scss'; // build-ignore-line
...
class OverviewSidebarSection extends React.PureComponent {
  ...
  static renderSocialIcon({ Icon, url }) {
    return (
      <a href={url} className="OverviewSidebarSection__headline__social-icon">
  ...
  static renderHeadlineContent(content) {
    switch (content.type) {
      ...
      case 'social-icons':
        return (
          <div className="OverviewSidebarSection__headline__social-icons">
            {content.facebookUrl &&
